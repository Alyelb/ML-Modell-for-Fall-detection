...
\begin{table}[H]
\centering
\caption{Ergebnisse der Transferexperimente. Alle Werte auf
         subjektunabhängigen Testsplits; Fine-Tuning mit 60~Epochen.}
\label{tab:crossposition}
\small
\begin{tabularx}{\textwidth}{l l C{2.1cm} C{2.1cm} C{2.1cm}}
\toprule
\textbf{Experiment} & \textbf{Bedingung} & \textbf{Sensitivität} & \textbf{Spezifität} & \textbf{Genauigkeit} \\
\midrule
Referenz SisFall (Hüfte, 50\,Hz) & Test       & 98,0\,\% & 99,7\,\% & 99,6\,\% \\
\midrule
UMAFall Taille (Kontrolle)       & Zero-Shot  & 42,2\,\% & 97,4\,\% & 92,6\,\% \\
                                 & Fine-Tuned & 92,2\,\% & 97,3\,\% & 96,9\,\% \\
\midrule
UMAFall Knöchel                  & Zero-Shot  & 34,8\,\% & 92,2\,\% & 88,5\,\% \\
                                 & Fine-Tuned & 80,1\,\% & 94,7\,\% & 93,8\,\% \\
\midrule
SisFall bei 20\,Hz               & Test       & 96,8\,\% & 99,3\,\% & 99,1\,\% \\
\midrule
UMAFall Knöchel bei 20\,Hz       & Zero-Shot  & 34,0\,\% & 95,6\,\% & 91,6\,\% \\
...
Die Kontrollexperimente führen zu einem Ergebnis, das der ursprünglichen
Arbeitshypothese teilweise widerspricht und daher besonders
hervorzuheben ist.

\textbf{Erstens dominiert nicht die Sensorposition, sondern der
Datensatzwechsel.} Der Taillensensor von UMAFall entspricht der
Aufnahmeposition von SisFall. Wäre die Position die maßgebliche
Ursache des Leistungsabfalls, müsste die Sensitivität dort nahezu
erhalten bleiben. Tatsächlich fällt sie jedoch bereits an der Taille
von $98{,}0\,\%$ auf $42{,}2\,\%$. Der Anteil, der zusätzlich auf den
Wechsel von der Taille zum Knöchel entfällt, beträgt lediglich
weitere $7{,}4$~Prozentpunkte (auf $34{,}8\,\%$). Die
Domänenlücke ist somit zu etwa $55{,}8$~Prozentpunkten dem
Datensatzwechsel (abweichende Sensorhardware, Aufnahmeprotokoll,
Probandenkollektiv und Sturztypen) und nur zu rund
$7$~Prozentpunkten der Sensorposition zuzuschreiben. Auch nach dem
Fine-Tuning bleibt der reine Positionsanteil mit
$92{,}2\,\%$ gegenüber $80{,}1\,\%$ moderat.

\textbf{Zweitens ist die Abtastrate als Störfaktor auszuschließen.}
Die Vermutung, das notwendige Hochtasten der UMAFall-Daten von
$20$\,Hz auf $50$\,Hz trage wesentlich zum Leistungsabfall bei,
bestätigt sich nicht: Wird das Modell direkt bei $20$\,Hz trainiert
und ohne Hochtasten übertragen, ändert sich die Zero-Shot-Sensitivität
nur von $34{,}8\,\%$ auf $34{,}0\,\%$. Die Abtastrate erklärt den
Effekt folglich nicht.

\textbf{Drittens bestätigt das Experiment die Abtastratenempfehlung aus
Kapitel~\ref{ch:properties} empirisch.} Das ausschließlich auf
SisFall trainierte Modell erreicht bei $20$\,Hz eine Sensitivität von
$96{,}8\,\%$ und eine Spezifität von $99{,}3\,\%$ gegenüber
$98{,}0\,\%$ bzw.\ $99{,}7\,\%$ bei $50$\,Hz. Eine Reduktion der
Abtastrate um $60\,\%$ kostet somit lediglich rund einen
Prozentpunkt Sensitivität. Die in Abschnitt~\ref{sec:samplingrate}
aus der Literatur abgeleitete Empfehlung von $20$--$50$\,Hz wird
dadurch mit eigenen Messungen gestützt; für das batteriebetriebene
Zielsystem ist $20$\,Hz ein energetisch attraktiver Arbeitspunkt.

\textbf{Viertens ist Transfer Learning in allen Konfigurationen
wirksam.} Das Fine-Tuning hebt die Sensitivität an der Taille von
$42{,}2\,\%$ auf $92{,}2\,\%$ und am Knöchel von $34{,}8\,\%$ auf
$80{,}1\,\%$, ohne die Spezifität zu beeinträchtigen (Knöchel:
$92{,}2\,\%$ auf $94{,}7\,\%$). Gegenüber einem kürzeren Training mit
20~Epochen (Sensitivität $77{,}3\,\%$, Spezifität $80{,}7\,\%$)
verbessert die Verlängerung auf 60~Epochen beide Kennzahlen deutlich,
was die zuvor beobachtete, noch fallende Validierungsverlustkurve
bestätigt.

\textbf{Konsequenz für das Projekt.} Da der Leistungsabfall
überwiegend aus dem Datensatzwechsel und nicht aus der Sensorposition
resultiert, ist zu erwarten, dass \emph{jedes} ausschließlich auf
öffentlichen Daten trainierte Modell auf der Zielhardware
(ESP32-C6 mit MPU-6050) einen vergleichbaren Einbruch zeigt --
unabhängig davon, wie nah die Trainingsposition der Sohle kommt. Die
Erhebung eines eigenen Pilotdatensatzes mit der tatsächlichen
Zielhardware ist damit nicht nur wünschenswert, sondern für ein
belastbares System notwendig. Zugleich zeigen die Ergebnisse, dass
bereits eine vergleichsweise kleine Menge domänenspezifischer Daten
ausreicht, um den größten Teil des Rückstands aufzuholen. Positiv
für das Vorhaben ist ferner, dass der reine Positionseffekt
(Taille gegenüber Knöchel) mit $7$ bis $12$~Prozentpunkten
vergleichsweise gering ausfällt, was die Machbarkeit der
fußnahen Anbringung stützt.
