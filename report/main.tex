...
Database\footnote{\url{https://github.com/tg0uk/Smart_Insole_Database}}
...
Klasse \enquote{Sturz} ist jedoch im fußnahen Kontext falsch.
...
\textbf{Mehrstufige Alarmauslösung.} Angesichts der in
Abschnitt~\ref{sec:fptest} ermittelten Fehlalarmrate ist eine
Einzelfensterentscheidung für den praktischen Einsatz ungeeignet. Die
Firmware sollte einen Alarm erst auslösen, wenn mehrere
aufeinanderfolgende Fenster positiv klassifiziert werden. Ein
tatsächlicher Sturz erzeugt aufgrund seiner Dauer typischerweise
mehrere positive Fenster in Folge, während ein einzelner
Fersenauftritt nur ein einzelnes Fenster betrifft. Diese zeitliche
Plausibilisierung ist rechnerisch praktisch kostenlos und dürfte die
Fehlalarmrate deutlich senken.
...
bis~\ref{sec:progressive} berichteten Experimente umfassen drei
externe Datensätze (KFall, UMAFall, FallAllD), ein
Clipping-Kontrollexperiment, einen Falsch-Positiv-Test auf fußnahen
Alltagsdaten sowie einen Vergleich dreier Transferstrategien.

Insgesamt wurden drei Hypothesen widerlegt -- die vermutete Dominanz
der Sensorposition, die alleinige Erklärungskraft der Abtastrate und
der Einfluss des Messbereichs -- sowie vier bestätigt: die konsistente
Wirksamkeit des Fine-Tunings, die dominierende Rolle
sensorspezifischer Signalcharakteristiken beim Domänentransfer, die
Notwendigkeit fußspezifischer Trainingsdaten zur Beherrschung der
Fehlalarmrate und der Vorteil eines progressiven gegenüber einem
direkten Anpassungsvorgehen.
...
\item \textbf{Zeitliche Plausibilisierung:} Implementierung und
      Parametrierung einer Mehrheitsentscheidung über $N$
      aufeinanderfolgende Fenster zur Reduktion der in
      Abschnitt~\ref{sec:fptest} ermittelten Fehlalarmrate.
